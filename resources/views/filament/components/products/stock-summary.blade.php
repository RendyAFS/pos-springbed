<div class="rounded-xl border border-gray-200 dark:border-gray-700 overflow-hidden">
    <div
        ...
        @if (collect($pending)->isNotEmpty())
            <span
                class="inline-flex items-center gap-1 text-xs font-medium text-amber-700 bg-amber-100 px-2 py-1 rounded-full">
            ...
            @foreach ($stocks as $stock)
                ...
                <div
                    ...
                    <div class="flex items-center gap-2">
                        @if ($stock->has_pending)
                            <span
                                class="text-xs text-amber-600 bg-amber-50 px-2 py-0.5 rounded-full font-medium border border-amber-200">
                                pending
                            </span>
                        @endif

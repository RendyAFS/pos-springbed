    ...
    <div class="relative z-10 w-full max-w-md mx-4 rounded-xl shadow-2xl overflow-hidden
        ...
        <div class="flex flex-col items-center gap-4 px-6 pt-6 pb-4">
            ...
            <p class="mt-2 text-sm text-gray-600 dark:text-gray-400">
                ...
                The bundle will become available again.
            </p>
        ...
        <div class="flex items-center gap-3 px-6 py-4">
            ...
            <button wire:click="restoreBundle" wire:loading.attr="disabled" wire:target="restoreBundle" type="button"
                class="flex w-full flex-row items-center justify-center gap-2 px-4 py-3
                ...
                <span wire:loading.remove wire:target="restoreBundle" class="inline-flex items-center space-x-2">
                    <x-heroicon-o-arrow-path class="w-5 h-5 inline-block" />
                    <span>Restore</span>
                </span>

                <span wire:loading wire:target="restoreBundle" class="inline-flex items-center space-x-2">
